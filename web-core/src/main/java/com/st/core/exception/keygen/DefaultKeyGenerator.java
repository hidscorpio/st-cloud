...
package com.st.core.exception.keygen;
...
public final class DefaultKeyGenerator implements KeyGenerator {
    ...
    public synchronized Number generateKey() {
        ...
        if (!(lastTime <= currentMillis)) {
            throw new IllegalStateException(String.format("Clock is moving backwards, last time is %d milliseconds, current time is %d milliseconds", lastTime, currentMillis));
        }
        if (lastTime == currentMillis) {
